""" An alarm clock currently built in python 2.7 (ready to move to 3).
    Accepts URLs for youtube songs as the ringtone, and randomly selects a song to play.
    Time input is HH:MM (ie. 08:15).
    URLs stored in a .txt file.
    Originally created by Lior "ShadowMuffin" Dahan. """
